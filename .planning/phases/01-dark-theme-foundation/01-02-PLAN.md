...
<task type="auto">
  <name>Task 1: Create turquoise-expanded variant file</name>
...
4. Confirm dark mode uses turquoise palette
5. Confirm light mode is unchanged
6. Verify schema reference is correct
</verification>
